...
# Full HA: 3 AZs, multi-NAT, Karpenter autoscaling, strict security
...
module "eks" {
  ...
  node_instance_types = ["m6i.2xlarge", "m7i.2xlarge"]
  node_desired_size  = 5
  node_min_size      = 5
  node_max_size      = 100  # Aligned with tfvars and Karpenter capacity
